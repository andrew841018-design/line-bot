...
JOB_REGISTRY["job-scraper-daily"] = JobSpec(
    command=[_PROJ_VENV, f"{_DATA_ENG}/job_scraper/run_daily.py"],
    cwd=f"{_DATA_ENG}/job_scraper",
    env={"PATH": _PROJECT_VENV_PATH, "HOME": "/Users/andrew", "USER": "andrew", "LOGNAME": "andrew", "PYTHONUNBUFFERED": "1"},
    timeout=180,
